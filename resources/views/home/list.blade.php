          ...
          <form action="{{route('home.search')}}" method="GET">
            ...
            <div class="row m-1">
              <div class="col-md-12 input-group">
                <input type="text" name="q" value="{{Request::get('q')}}" class="form-control" placeholder="Rechercher par nom" />
                <span class="input-group-append">
                  <button type="submit" class="btn btn-primary pt-1">
                    <span class="fas fa-search"></span> Bus de recherche
                  </button>
                </span>
              </div>
            </div>
  ...
  <div class="row ">
    <div class="col-sm-12 col-md-5 col-xl-4">
      <div class="card p-0 m-0">
        <div class="card-body p-3">
          <div class="d-flex align-items-center small mb-0">
            ...
            <strong>Affinez votre recherche d'autobus</strong>
          </div>
        </div>
      </div>
      <div class="card border-top-0">
        <div class="card-body p-3" id="jobCategories">
          <div class="pb-0">
            <div class="card-title mb-1">Jours d'arrivée</div>
      ...
      <div class="card border-top-0">
        <div class="card-body p-3" id="jobCategories">
          <div class="pb-0">
            <div class="card-title mb-1">Lieu d'arrivée des bus</div>
            <div class="card-body p-0">
              <div class="form-group">
    ...
    <div class="col-sm-12 col-md-7 col-xl-8">
      ...
      <div class="card-body">
        ...
        @else
        <div class="bg-white p-3 shadow mb-3">
          <p class="h5 text-center mb-4">Pas de tels résultats. Rechercher un autre nom</p>
          <div class="row">
